  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'radial-gradient(ellipse at top, #0a1628 0%, #050d1a 50%, #020810 100%)',
        'card-gradient': 'linear-gradient(135deg, rgba(0,212,255,0.05) 0%, rgba(0,153,204,0.02) 100%)',
      },
      backgroundSize: {
        'grid': '50px 50px',
      },
